<%-- 
    Document   : viewStatus
    Created on : Nov 29, 2016, 1:17:12 AM
    Author     : ANIK
--%>
...
<html>
    ...
    <body>
        <div id="new_project">
        <form action="/ProjectManagement-war/createStatus3.jsp" class="inline">
            <button class="button">New Project</button><br/></br/></br/>
        </form>
        </div>
        <%
           PMLocal pm=null;
        ...
        <div id="status_table">
            <h1 style="color:#3D3B38;" align="center">Existing Projects</h1>
            <form name="searchForm2" action="searchStatus2.jsp">
                &nbsp;<input type="text" placeholder="project name" name="search_name" id="search_box"/>
                &emsp;<input type="submit" name="submitForm" value="Search" class="search_button"/><br/><br/>
            </form>  
